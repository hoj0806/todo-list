function TodoListItemPopup() {
  return (
    <div className='absolute top-0 w-full h-full bg-black bg-opacity-50 z-10'>
      <div className='w-[320px] h-[180px] bg-yellow rounded-xl py-4 text-center flex flex-col mx-auto mt-[280px]'>
        ...
        <div className='flex justify-center gap-6'>
          ...
          <button className='w-[76px] h-6 bg-white-10 text-sm'>아니요</button>
        </div>
      </div>
    </div>
  );
